...
const AnimeCard = ({anime, animeInfo, status}) => {
  ...
  return (
    <div className=' flex gap-3 relative border border-gray-800/20 justify-start p-4 bg-[#1b1b1b] rounded-lg'>
      {/* Image Contianer */}
      ...
      <div className='flex-1 flex flex-col justify-between'>
        ...
        <div className='flex gap-2 items-center h-9'>
          ...
          {/* Update btn */}
          <button onClick={handleUpdate} title='update' className='bg-pink-600 hover:bg-pink-500 cursor-pointer px-2 rounded-lg h-full'>
