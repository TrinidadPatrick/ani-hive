...
const ScorePicker = ({score, setScore}) => {
    ...
    <div className='h-full relative'>
        <button onClick={(e)=>{e.stopPropagation();setIsOpen(true)}} className=" flex items-center gap-1 rounded-lg bg-[#25252D] hover:bg-[#1b1b1b] border border-pink-500 px-2 h-full cursor-pointer">
