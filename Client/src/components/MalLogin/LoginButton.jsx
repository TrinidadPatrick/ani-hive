...
const LoginButton = () => {
  ...
  return (
    ...
    title='Login to MAL'
        onClick={login}
        className="cursor-pointer h-full group relative px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 ease-out"
      >
