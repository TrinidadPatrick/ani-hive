      ...
      <div className={`${window.location.pathname === '/explore' && 'hidden'} w-[80%]  flex mx-auto justify-center`}>
          ...
          <div className="relative">
            ...
            >
              ...
              <span className='hidden :block'>Search</span>
            </button> 
        </div>
        </div>
      </div>
    ...
    <nav className='w-full fixed backdrop-blur z-99999 p-4 flex justify-between items-center gap-5'>
      ...
      <div className={`hidden w-full justify-end sm:flex `}>
        ...
        <div className="relative w-full">
                ...
                <button
                  onClick={()=>{if(searchinput?.length !== 0){handleSearch()}}}
                  className="absolute top-1 right-1 flex items-center justify-center rounded py-1.5 xl:py-1 px-2.5 border border-transparent text-center text-sm text-white transition-all shadow-sm hover:shadow bg-pink-600 hover:bg-pink-500"
                  type="button"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4 xl:mr-2">
                    <path fillRule="evenodd" d="M10.5 3.75a6.75 6.75 0 1 0 0 13.5 6.75 6.75 0 0 0 0-13.5ZM2.25 10.5a8.25 8.25 0 1 1 14.59 5.28l4.69 4.69a.75.75 0 1 1-1.06 1.06l-4.69-4.69A8.25 8.25 0 0 1 2.25 10.5Z" clipRule="evenodd" />
                  </svg>
