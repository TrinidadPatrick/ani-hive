...
const UserLayout = () => {
  ...
  return (
    ...
    {
      showSidebar &&
      <div data-aos="fade-left" data-aos-easing="ease-in-out" className='w-full  flex md:hidden flex-col justify-center gap-5 h-[100svh] fixed bg-[#141414] z-[999999999999999999]'>
      <div>
