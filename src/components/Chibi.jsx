            ...
            <img src={chibi} alt="chibi" className=' w-full h-full object-cover ' />
                ...
                <div className="absolute bottom-[75%] left-1/4 transform -translate-x-1/2">
                    <div className="relative bg-themeDark border py-2 border-themeLightDark text-sm flex flex-col gap-3 text-white px-3 rounded-lg shadow-lg origin-bottom">
                        ...
                        <button onClick={() => {handleScroll('season-now');setIsOpen(false)}} className="whitespace-nowrap text-start cursor-pointer hover:text-gray-200">Popular this season</button>
                        <button onClick={() => {handleScroll('ongoing');setIsOpen(false)}} className="whitespace-nowrap text-start cursor-pointer hover:text-gray-200">Ongoing Animes</button>
                        <button onClick={() => {handleScroll('airing-today');setIsOpen(false)}} className="whitespace-nowrap text-start cursor-pointer hover:text-gray-200">Airing Today Animes</button>
                        <button onClick={() => {handleScroll('upcoming');setIsOpen(false)}} className="whitespace-nowrap text-start cursor-pointer hover:text-gray-200">Upcoming Animes</button>
                        <button onClick={() => {handleScroll('movies');setIsOpen(false)}} className="whitespace-nowrap text-start cursor-pointer hover:text-gray-200">Anime Movies</button>
