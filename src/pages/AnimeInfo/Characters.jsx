...
const Characters = React.memo(({ mal_id }) => {
...
const CharacterCard = React.memo(({ char, va, isSmallScreen }) => {
    const navigate = useNavigate();
    ...
    return (
        ...
        >
            <motion.div
                ...
                animate={{ rotateY: isHovered && hasVA ? 180 : 0 }}
            ...
            >
                ...
                >
                    ...
                    <div className="w-full h-fit rounded-lg overflow-hidden shadow-sm relative">
                    ...
                    {/* Info */}
                    <div className="w-full absolute px-1 md:px-3 py-1 bottom-0 bg-gradient-to-t from-black/90 to-transparent pt-3 rounded-b-lg flex z-[99]">
