...
import { useSeasonNowAnime } from "../../hooks/useSeasonNowAnime";
...
const SeasonNowAnime = ({ handleSetScrollPosition }) => {
  ...
  const { data: SeasonNowAnime, isLoading } = useSeasonNowAnime();
        ...
        <section className="w-full sm:h-fit lg:h-[80svh] lg:max-h-[80svh] bg-red-100 flex items-center relative">
          ...
          >
            {SeasonNowAnime?.length > 0 &&
              SeasonNowAnime.sort((a, b) => a.popularity - b.popularity).map(
                (anime, index) => {
                  if (
                    SeasonNowAnime[index - 1]?.mal_id != anime?.mal_id &&
                    anime.title
                  ) {
                      ...
                      <section className="px-5 w-full h-full lg:h-[80svh] bg-themeExtraDarkBlue relative overflow-hidden flex items-center justify-center">
                        ...
                        <div className="relative mx-3 sm:mx-10 xl:mx-0 z-10 flex flex-col-reverse lg:flex-row items-center gap-10 w-full max-w-7xl xl:max-w-[85rem] ">
                          ...
                          <div className="text-white h-fit flex-1 w-full space-y-5 p-3 md:p-0">
                            <div>
                              <p className="text-base text-gray-300 font-light">
                                Popular animes this season
                              </p>
                              <h1 className="text-3xl md:text-4xl lg::text-5xl xl:text-[3.4rem] font-bold line-clamp-2 max-w-lg mt-3 ">
                            ...
                            <p className="text-sm text-gray-300 max-w-prose">
                              ...
                              {anime?.synopsis?.length > 500 && (
                                <button
                                  ...
                                  className="inline px-1 font-medium cursor-pointer"
                                >
                            ...
                            <button
                              ...
                              className="mt-4 bg-pink-600 cursor-pointer hover:bg-pink-500 text-white font-semibold py-2 px-5 rounded-lg shadow-lg transition duration-300"
                            >
                              Overview
                            </button>
                            <button
                              ...
                              className=" hover:bg-gray-50/2 md:hidden ml-3 mt-4 cursor-pointer bg-transparent border text-white font-semibold py-2 px-5 rounded-lg shadow-lg transition duration-300"
                            >
                              Watch Trailer
                            </button>
                          </div>
                          ...
                          <div className="relative hidden md:block aspect-video rounded-lg overflow-hidden w-2xl lg:w-md xl:w-xl">
                            <img
                              src={`https://img.youtube.com/vi/${yt_id}/sddefault.jpg`}
                            ...
                            <button
                              ...
                              className="absolute bg-red-500 text-white text-4xl px-6 py-2 rounded-xl hover:bg-red-400 cursor-pointer z-30 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2"
                            >
                              ▶
                            </button>
                          </div>
