    ...
    <main>
      ...
      {true && (
        ...
        >
          ...
          <div
            onClick={() => navigate("/")}
            className="flex ps-5 cursor-pointer w-full justify-center"
          >
          ...
          {/* Sidebar Search */}
          <div
            className={`${path === "/explore" && "hidden"} w-[80%] flex mx-auto justify-center`}
          >
            <div className="w-full max-w-sm min-w-[200px] flex gap-2">
              ...
              <div className="relative w-full">
                ...
                <button
                  onClick={() => {
                    if (searchinput?.length !== 0) handleSearch();
                  }}
      ...
      <nav className="w-full fixed backdrop-blur z-[9999] p-4 flex justify-between items-center gap-5">
        ...
        <ul className="w-full hidden md:flex text-white justify-end gap-5 lg:gap-10 pe-10 z-10">
          <li>
            <button
              onClick={() => navigate("/")}
              className={`${path === "/" || path.startsWith("/anime/") ? "border-b-2 border-b-pink-500 text-pink-500 font-bold" : "text-gray-300 font-sans"} cursor-pointer text-sm lg:text-base`}
            >
              Home
            </button>
          </li>
          <li>
            <button
              ...
              className={`${path === "/schedule" ? "border-b-2 border-b-pink-500 text-pink-500 font-bold" : "text-gray-300 font-sans"} cursor-pointer text-sm lg:text-base`}
            >
              Schedule
            </button>
          </li>
          <li>
            <button
              ...
              className={`${path === "/explore" ? "border-b-2 border-b-pink-500 text-pink-500 font-bold" : "text-gray-300 font-sans"} cursor-pointer text-sm lg:text-base`}
            >
              Explore
            </button>
          </li>
          <li>
            <button
              ...
              className={`${path === "/characters" ? "border-b-2 border-b-pink-500 text-pink-500 font-bold" : "text-gray-300 font-sans"} cursor-pointer text-sm lg:text-base`}
            >
              Characters
            </button>
          </li>
        ...
        <div className="hidden w-full justify-end sm:flex">
          <div
            className={`w-full ${path === "/explore" ? "hidden" : "sm:flex"} max-w-sm min-w-[200px] gap-2`}
          >
            <ImageSearch />
            <div className="relative w-full">
              <input
