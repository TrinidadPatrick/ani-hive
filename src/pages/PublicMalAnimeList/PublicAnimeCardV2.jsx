...
const PublicAnimeCardV2 = ({ anime, animeInfo }) => {
  ...
  return (
    <div
      ...
      className="anime-card cursor-pointer bg-themeDarker rounded-lg group overflow-hidden relative h-full flex flex-col"
    >
      {/* Image Container */}
      <div className="flex-none relative aspect-[3/4] overflow-hidden">
        ...
        <div className="w-full flex flex-row justify-start gap-1 absolute bottom-2 left-2">
          <div className="hidden xs:flex h-full cursor-default px-1.5 sm:px-3 border border-pink-700 justify-center items-center rounded-md bg-pink-600 py-0.5">
            <span className="text-gray-100 capitalize text-[0.7rem] sm:text-[0.8rem] text-center">
          ...
          {anime.status === "currently_airing" && (
            <div className="h-full cursor-default px-1.5 sm:px-3 justify-center border border-themeDark flex items-center rounded-md bg-themeDark py-0.5">
              {anime?.airInfo ? (
                <span className="text-gray-100 capitalize text-[0.7rem] sm:text-[0.8rem] whitespace-nowrap">
                  {anime?.airInfo}
                </span>
              ) : (
                <div className="py-2">
...
export default PublicAnimeCardV2;
