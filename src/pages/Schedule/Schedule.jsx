        ...
        {days.map((day, index) => {
          return (
            <button
              ...
              className={`text-white font-medium px-3 py-2 ${day == selectedDay ? "bg-pink-500" : "bg-[#4a4a4a39]"} hover:bg-pink-500 rounded cursor-pointer`}
            >
              {day}
            </button>
          );
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute bottom-0 left-0 right-0 p-6 text-white">
                          <div
                            className={`transition-all duration-300 ${hovered === index ? "translate-y-0 opacity-100" : "translate-y-2 opacity-90"}`}
                          >
                          ...
                          {hovered === index && (
                            <button
                              onClick={() =>
                                navigate(
                                  `/anime/${anime?.mal_id}?title=${slugify(anime?.title_english || anime?.title || "")}`,
                                )
                              }
                              className="cursor-pointer mt-4 px-4 py-2 bg-pink-600 hover:bg-cyan-500 rounded-lg text-sm font-semibold transition-all duration-300 transform hover:scale-105"
                            >
                              View Details
                            </button>
                          )}
